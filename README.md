...
## [Impacting Student Outcomes Through Strategic Data Analytics](Student%20Instruction%20Database%20%26%20Analysis%20Project)
...
**Conclusion**: Postgres queries were used to filter information and draw conclusions on what should be altered in instruction methods, including session length, and length of time spent as a student. Through comparative processes and analysis, it was ultimately determined that a combination of shorter, more focused sessions were more conducive to higher grade averages for the students’ essay assignments, observable after only a period of 3 to 5 weeks. 
